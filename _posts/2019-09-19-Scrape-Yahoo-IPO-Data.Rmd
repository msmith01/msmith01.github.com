...
I try to recreate some of the plots on J.R.Ritters website for each of the sections 

```{r, out.width="0.3\\linewidth", include=TRUE, fig.align="center", fig.cap=c("your caption"), echo=FALSE}
knitr::include_graphics("/_posts/posts_img/Monthly_bloomberg_graphs.pdf")
```
